...
import logo from "../../images/נופר חלפון לוגו.png"
...
const NavBarNew = () => {
  ...
  const handleClick = () => {
    const phoneNumber = "+972542162227";
    const message = "היי נופר הגעתי מהדף שלך, אני רוצה לשמוע ממך עוד על..";
  ...
  const menuItems = ['הכלות שלי','יש לי אירוע ערב' , 'שאלות תשובות', 'מי אני'];
